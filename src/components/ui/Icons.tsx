...
/**
 * Renders a spinning loader icon, used to indicate a loading state.
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * Renders a hamburger menu icon (three lines).
 * @returns {JSX.Element} The rendered SVG icon.
 */
...
/**
 * Renders a pencil icon, used for editing.
 * @returns {JSX.Element} The rendered SVG icon.
 */
